...
const fn = async (query, isFromTransfer) => {
	...
	// If there is no problem with preprocessing, execute the api function.
	// 		The api function can be:
	// 				1. Defined by customer in api folder;
	// 				2. Generated by noapi (in /src/api/init/fixFn.js).
	// 		The api function will calls biz function (via /src/biz/do.js) to executes the business logic.
	//		The /src/biz/do.js will handles the parameters in query, such as automatically parses json str.
